...
<div class="notice notice-warning is-dismissible">
	...
	<p class="submit"><a class="button-primary" href="<?php echo esc_url( admin_url( 'admin.php?page=tplc-status' ) ); ?>"><?php _ex( 'Child Theme Check', 'Page and Menu Title', 'child-theme-check' ); ?></a> <a class="skip button-primary" href="<?php echo esc_url( add_query_arg( 'hide_template_files_notice', 'template_files' ) ); ?>"><?php _e( 'Hide this notice permanently', 'child-theme-check' ); ?></a></p>
</div>
